...
class ComparingAndOrdering:
    ...
    def GenerateProblemSequential(self,LastProblemID):
        ...
        self.GenerateProblemType = {1:[self.GenerateProblemType1(),self.GenerateProblemTypeMCQ1(),],
                                    ...
                                    6:[self.GenerateProblemTypeMCQ6(),],
                                    }
    ...
    def ExplainType1(self,problem,answer,numbers):
        k = 0
        self.place = {1:"first",2:"second",3:"third",4:"fourth",5:"fifth"}
        ...
        while len(numbers)!=1:
            ...
            for i in range(len(numbersDigit)):
                if numbersDigit[i]!=max(numbersDigit):
                    ...
                    j=j+1
            if len(numbers)>1:
                self.solution_text = self.solution_text + "Greatest out of these digits is "+str(max(numbersDigit))+" which belongs to numbers "+str(numbers)+". So we cannot determine the greatest number by this digit <br>"
            k=k+1
    ...
    def GenerateProblemType3(self):
        ...
        self.problem = "Rearrange the following digit to form the greatest possible 5 digit number:<br>%d %d %d %d %d"%(self.digits[0],self.digits[1],
    ...
    def GenerateProblemType4(self):
        ...
        self.problem = "Rearrange the following digit to form the smallest possible 5 digit number:<br>%d %d %d %d %d"%(self.digits[0],self.digits[1],
                                                                                                                       self.digits[2],self.digits[3],
                                                                                                                       self.digits[4])
    ...
    def GenerateProblemTypeMCQ5(self):
        ...
        '''Explanation starts...'''
        self.explain_template = "Explanation.html"
        self.explain_text = self.ExplainType5(self.problem,str(self.answer),self.numbers)
        self.explain = {"explain_template":self.explain_template,"explain_text":self.explain_text,
                             "video_link":"www.homecampus.com.sg","explain_note":""}
        '''Explanation ends'''
    ...
    def ExplainType5(self,problem,answer,numbers):
        self.answer_text = "<br>The correct answer is:<br>"+answer
        self.solution_text =  "<b><u>Problem</b></u>:<br/>"
        self.solution_text = self.solution_text + "<i>"+problem + "</i><br/><br/>"
        self.solution_text = self.solution_text + "<b><u>Solution</b></u>:<br/>"
    ...
    def checkAnswer(self,template,answer,Input,CheckAnswerType):
        ...
        '''remove the "," from input only if its a string'''
        Input = str(Input)
