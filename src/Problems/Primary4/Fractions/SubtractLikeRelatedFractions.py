...
Module: SubtractLikeRelatedFractions
Generates "subtraction proper fractions" problems for Primary 4
...
class SubtractLikeRelatedFractions:
    ...
    def GenerateProblemType1(self):
        ...
        # Making sure that first fraction is not a whole number
        while (self.numerator1+self.numerator2)%self.denominator==0:
            self.numerator1 = randint(1,self.denominator-1)
        self.AnswerNumerator = self.numerator1
        self.numerator1 = self.numerator1 + self.numerator2
        
        self.problem = "Subtract:<br>"
    ...
    def ExplainType1(self,problem,answer1,answer2,numerator1,numerator2,denominator):
        ...
        self.solution_text = self.solution_text + "<br>To subtract like fractions, simply subtract the two numerators.<br><br>"
    ...
    def GenerateProblemType2(self):
        ...
        self.problem = "Subtract and express the fraction in its simplest form:<br>"
        self.problem = self.problem + "<table id='fractionTable' class='FractionsTable'><tr>"
        self.problem = self.problem + "<td align='center'><u>"+"&nbsp;"*len(str(self.denominator))+str(self.numerator1)+"&nbsp;"*len(str(self.denominator))+"</u><br>&nbsp;"+str(self.denominator)+"</td>"
        self.problem = self.problem + "<td> &nbsp;-&nbsp; <td>"
        self.problem = self.problem + "<td align='center'><u>"+"&nbsp;"*len(str(self.denominator))+str(self.numerator2)+"&nbsp;"*len(str(self.denominator))+"</u><br>&nbsp;"+str(self.denominator)+"</td>"
    ...
    def GenerateProblemType5(self):
        ...
        self.numerator1 = self.numerator1 + self.numerator2*self.multiplier + self.numerator3*self.multiplier
    ...
    def GenerateProblemTypeMCQ1(self):
        ...
        self.wrongAnswers.append([self.WrongMixed,self.AnswerNumerator+3,self.WrongDenominator])
        if self.AnswerNumerator-1!=0:
            self.wrongAnswers.append([self.WrongMixed,self.AnswerNumerator-1,self.WrongDenominator])
    ...
    def GenerateProblemTypeMCQ2(self):
        ...
        self.wrongAnswers.append([self.WrongMixed,self.AnswerNumerator+3,random.choice([self.AnswerDenominator,self.answer2])])
        if self.AnswerNumerator-1!=0:
            self.wrongAnswers.append([self.WrongMixed,self.AnswerNumerator-1,random.choice([self.AnswerDenominator,self.answer2])])
        if gcf!=1:
